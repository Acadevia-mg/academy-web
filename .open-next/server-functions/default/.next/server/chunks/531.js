  ...
  (exports.modules = {
    ...
    28531: (e, t, r) => {
      ...
      let y = u.default.forwardRef(function (e, t) {
        ...
        let x = u.default.useContext(a.AppRouterContext),
          C = null === b ? f.PrefetchKind.AUTO : f.PrefetchKind.FULL,
          { href: S, as: T } = u.default.useMemo(() => {
            let e = p(l);
            return { href: e, as: y ? p(y) : e };
          }, [l, y]),
          I = u.default.useRef(S),
          w = u.default.useRef(T);
        M && (n = u.default.Children.only(r));
        let k = M ? n && "object" == typeof n && n.ref : t,
          [A, R, N] = (0, i.useIntersection)({ rootMargin: "200px" }),
          U = u.default.useCallback(
            (e) => {
              ((w.current !== T || I.current !== S) &&
                (N(), (w.current = T), (I.current = S)),
                A(e));
            },
            [T, S, N, A],
          ),
          q = (0, c.useMergedRef)(U, k);
        u.default.useEffect(() => {}, [T, S, R, !1 !== b, x, C]);
        let F = {
          ref: q,
          onClick(e) {
        ...
        return (
          (0, s.isAbsoluteUrl)(T)
            ? (F.href = T)
            : (M && !g && ("a" !== n.type || "href" in n.props)) ||
              (F.href = (0, d.addBasePath)(T)),
          M
            ? u.default.cloneElement(n, F)
            : (0, o.jsx)("a", { ...E, ...F, children: r })
        );
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
          ...
          () =>
            e && t
              ? (n) => {
                  null === n
                    ? (r.current(), o.current())
                    : ((r.current = u(e, n)), (o.current = u(t, n)));
                }
              : e || t,
          [e, t],
        );
