  ...
  (exports.modules = {
    ...
    56380: (e, t, i) => {
      ...
      function p(e, t, i, n, r, o = 0, h = 0, a = n, s = r) {
        ...
        let m = n - (d.x + d.width);
        m < 0 && ((d.x = Math.min(d.x, n - l)), (d.width += m));
        let u = r - (d.y + d.height);
        if (
          (u < 0 && ((d.y = Math.min(d.y, r - c)), (d.height += u)),
          d.width < l &&
      ...
      let g = { capture: !0, passive: !1 },
        m = 0,
        u = class e extends n.PureComponent {
          constructor() {
            (super(...arguments),
              ...
              h(this, "onHandlerKeyDown", (t, i) => {
                ...
                let y = (
                  ...
                  x = p(
                    ...
                    })(w(r, u.width, u.height), t.key, y, i),
                    n,
                    i,
                    u.width,
                    u.height,
          ...
          resizeCrop() {
            ...
            "ne" === l
              ? ((m.x = t.startCropX),
                (m.width = w),
                i ? (m.height = m.width / i) : (m.height = Math.abs(g)),
                (m.y = t.startCropY - m.height))
              : "se" === l
                ? ((m.x = t.startCropX),
                  (m.y = t.startCropY),
                  (m.width = w),
                  i ? (m.height = m.width / i) : (m.height = g))
                : "sw" === l
                  ? ((m.x = t.startCropX + w),
                    (m.y = t.startCropY),
                    (m.width = Math.abs(w)),
                  ...
                  : "nw" === l &&
                    ...
                    i
                      ? ((m.height = m.width / i),
                        (m.y = t.startCropY - m.height))
                      : ((m.height = Math.abs(g)), (m.y = t.startCropY + g)));
            let u = p(m, i, l, o.width, o.height, h, a, n, r);
            return (
              i || e.xyOrds.indexOf(c) > -1
                ? (d = u)
                : e.xOrds.indexOf(c) > -1
                  ? ((d.x = u.x), (d.width = u.width))
                  : e.yOrds.indexOf(c) > -1 &&
                    ((d.y = u.y), (d.height = u.height)),
      ...
      (h(u, "xOrds", ["e", "w"]),
        h(u, "yOrds", ["n", "s"]),
        h(u, "xyOrds", ["nw", "ne", "se", "sw"]),
        h(u, "nudgeStep", 1),
        h(u, "nudgeStepMedium", 10),
        h(u, "nudgeStepLarge", 100),
        h(u, "defaultProps", {
          ariaLabels: {
