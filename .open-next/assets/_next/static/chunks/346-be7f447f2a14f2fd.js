    ...
    1027: (e, r, o) => {
      ...
      let n = (e) => ("boolean" == typeof e ? `${e}` : 0 === e ? "0" : e),
        ...
        s = (e, r) => (o) => {
          ...
          let { variants: s, defaultVariants: a } = r,
          ...
          return l(
            ...
            null == r
              ? void 0
              : null === (t = r.compoundVariants) || void 0 === t
                ? void 0
                : t.reduce((e, r) => {
        ...
        i = (e, r) => {
          let o = (0, t.forwardRef)((o, s) => {
            ...
            return (0, t.createElement)(a, {
              ref: s,
              iconNode: r,
              className: l("lucide-".concat(n(e)), i),
              ...d,
            });
          });
      ...
      let J = (function (e, ...r) {
        ...
        return {
          ...
          classGroups: {
            ...
            grow: [{ grow: J() }],
            shrink: [{ shrink: J() }],
            order: [{ order: ["first", "last", "none", O, I] }],
            "grid-cols": [{ "grid-cols": [F] }],
            "col-start-end": [{ col: ["auto", { span: ["full", O, I] }, I] }],
            "col-start": [{ "col-start": Q() }],
            "col-end": [{ "col-end": Q() }],
            "grid-rows": [{ "grid-rows": [F] }],
            "row-start-end": [{ row: ["auto", { span: [O, I] }, I] }],
            ...
            "line-clamp": [{ "line-clamp": ["none", P, A] }],
            leading: [
              {
                leading: [
                  "none",
            ...
            "text-decoration-thickness": [
              { decoration: ["auto", "from-font", E, G] },
            ],
            "underline-offset": [{ "underline-offset": ["auto", E, I] }],
            ...
            "outline-offset": [{ "outline-offset": [E, I] }],
            "outline-w": [{ outline: [E, G] }],
            "outline-color": [{ outline: [e] }],
            "ring-w": [{ ring: T() }],
            "ring-w-inset": ["ring-inset"],
            "ring-color": [{ ring: [e] }],
            "ring-opacity": [{ "ring-opacity": [h] }],
            "ring-offset-w": [{ "ring-offset": [E, G] }],
            ...
            contrast: [{ contrast: [i] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", R, I] }],
